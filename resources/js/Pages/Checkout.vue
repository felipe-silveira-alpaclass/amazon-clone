...
const data = useForm({ payement_intent: null })

onMounted(() => {
    // A reference to Stripe.js initialized with a fake API key.
// Sign in to see examples pre-filled with your key.
    // var stripe = Stripe("pk_test_XKUpwPvvEnNxMsSzoLm8H3i8");
            ...
            <div class="w-4/12 border border-gray-400 rounded-md py-4 px-2">
                <form>
                    ...
                    <div class="flex justify-between text-xl text-red-700 font-extrabold border-y border-y-gray-300 my-3 p-2">
                        ...
                        <!-- <div v-if="order">
                            R$ {{ order.total_decimal }}
                        </div> -->
                    </div>
                    <button id="submit" class="bg-yellow-400 hover:bg-yellow-500 rounded-md text-sm font-extrabold p-2 w-full">
