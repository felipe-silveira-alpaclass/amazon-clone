...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="flex max-w-[1250px] mx-auto pt-4">
            ...
            <div class="w-8/12">
                <div class="flex items-stretch border-b border-b-gray-300 w-[calc(100%-100px)] pb-4 pl-4 mb-6">
                    ...
                    <div v-if="$page.props.auth.user && $page.props.auth.address" class="px-4 font-semibold">
                    ...
                    <div v-else class="px-4 font-semibold">
                        <div>Endereço não cadastrado</div>
                        <Link :href="route('address_options.index')">
            ...
            <div class="w-4/12 border border-gray-400 rounded-md py-4 px-2">
                ...
                <form id="payment-form">
                    ...
                    <div
                        ...
                        <div>Valor total:</div>
                        <div v-if="order">R$ {{ order.total_decimal }}</div>
                    </div>

                    <button id="submit"
                        class="w-full bg-yellow-400 hover:bg-yellow-500 rounded-md text-sm font-extrabold p-2">
                        <div v-if="isProcessing" id="button-text">Processando...</div>
                        <div v-else id="button-text">Pagar</div>
                    </button>
        ...
        <div class="w-[1200px] mx-auto text-xl font-bold pb-2 underline">Itens</div>
        <div class="w-[1200px] mx-auto" v-for="prod in JSON.parse(order.items)" :key="prod">
            <div class="flex items-center py-1">
                ...
                <div class="ml-4">
                    ...
                    <div class="font-semibold text-red-700">R${{ prod.price }}</div>
                </div>
            </div>
        </div>
    </AuthenticatedLayout>
