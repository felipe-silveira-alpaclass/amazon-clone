        ...
        <div class="max-w-[500px] mx-auto text-2xl font-extrabold">
            ...
            <form action="">
                ...
                <div class="mt-4">
                    ...
                    <TextInput name="name" type="text" class="mt-1 block w-full" required />
                </div>
                ...
                <div class="mt-3">
                    ...
                    <div class="mt-1 flex gap-2">
                        <div class="w-full">
                            ...
                            <TextInput type="text" class="mt-1 block w-full" required placeholder="Cidade" />
                        </div>

                        <div class="w-full">
                            <InputLabel class="-mb-1.5" value="CEP" />
                            <TextInput type="text" class="mt-1 block w-full" required placeholder="00000-000" />
                        </div>
